...
<script type="text/javascript">
  ...
  const upColor1 = '#ec0000';
  const upBorderColor1 = '#8A0000';
  const downColor1 = '#00da3c';
  const downBorderColor1 = '#008F28';
  ...
  option = {
    ...
    series: [{
        ...
        itemStyle: {
          color: upColor1,
          color0: downColor1,
          borderColor: upBorderColor1,
          borderColor0: downBorderColor1
        },
        markPoint: {
          label: {
